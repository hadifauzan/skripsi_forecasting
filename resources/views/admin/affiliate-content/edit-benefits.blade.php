...
@section('title', 'Edit Keuntungan affiliate')
...
@section('content')
    ...
    <div class="px-6 py-8">
        ...
        @elseif (str_contains($section, 'what-get-'))
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div class="bg-[#785576] p-6">
                    <div class="flex items-center text-white">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold">Edit Keuntungan {{ str_replace('what-get-', '', $section) }}
                            </h3>
                            <p class="text-purple-100 text-sm">Keuntungan bergabung sebagai affiliate affiliate</p>
                        </div>
                    </div>
                </div>
