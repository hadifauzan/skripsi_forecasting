...
@section('title', 'Edit Alasan affiliate')
    ...
    <div class="px-6 py-8">
        ...
        <div class="flex items-center justify-between py-5 font-nunito">
            <h2 class="font-nunito font-bold text-2xl text-[#614DAC]">
                Edit {{ $section === 'why-join-title' ? 'Why Join Us Title' : ucfirst(str_replace('-', ' ', $section)) }}
            </h2>
        ...
        @if ($section === 'why-join-title')
            {{-- Why Join Us Title Form --}}
        ...
        @elseif (str_contains($section, 'benefit-'))
                ...
                <div class="bg-[#785576] p-6">
                    <div class="flex items-center text-white">
                        ...
                        <div>
                            ...
                            <p class="text-purple-100 text-sm">Manfaat bergabung sebagai affiliate affiliate</p>
                        </div>
                    </div>
                </div>
