    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            <div class="mb-4 sm:mb-0">
                ...
                <p class="page-subtitle text-[#6C63FF] text-lg ml-11">Tambahkan produk baru untuk dijual</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" 
                           ...
                           required value="{{ old('name') }}" placeholder="Masukkan nama produk">
                    @error('name')
                ...
                <div>
                    ...
                    <select name="category" 
                        ...
                        <option value="aromatherapy" {{ old('category') == 'aromatherapy' ? 'selected' : '' }}>Aromatherapy</option>
                    </select>
                    @error('category')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="price" 
                               ...
                               required min="0" step="0.01" value="{{ old('price') }}" placeholder="0">
                    </div>
                    @error('price')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                ...
                <div>
                    ...
                    <input type="number" name="stock" 
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required min="0" value="{{ old('stock') }}" placeholder="0">
                    @error('stock')
                        <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                    @enderror
                </div>
