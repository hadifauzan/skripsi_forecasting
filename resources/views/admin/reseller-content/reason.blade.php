...
@section('title', 'Kelola Alasan Bergabung Reseller')
        ...
        <div class="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="bg-[#6B7280] p-6">
                <div class="flex items-center text-white">
                    <div>
                        <h3 class="text-xl font-semibold">Why Join Us - Alasan Bergabung</h3>
                        <p class="text-purple-100 text-sm">Kelola konten alasan mengapa bergabung sebagai reseller</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6 font-nunito">
                <div class="space-y-4">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-2 ml-4">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.reseller-content.section.edit', ['sectionKey' => 'reasons', 'section' => 'reseller-why-join-title']) }}"
                    ...
                    @for ($i = 1; $i <= 4; $i++)
                        @php
                            $benefit = $benefits->firstWhere('section', 'reseller-benefit-' . $i);
                        @endphp
                        <div
                            class="bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200 overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
                            <div
                                ...
                                <div class="flex items-center space-x-2 ml-4">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.reseller-content.section.edit', ['sectionKey' => 'reasons', 'section' => 'reseller-benefit-' . $i]) }}"
                                        class="text-blue-600 hover:text-blue-800 transition-all duration-300 p-2 rounded-full hover:bg-blue-100 hover:rotate-6"
