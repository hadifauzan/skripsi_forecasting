...
@section('title', 'Kelola Steps Reseller')
            ...
            <div class="bg-[#785576] p-6">
                <div class="flex items-center justify-between text-white">
                    <div>
                        ...
                        <p class="text-purple-100 text-sm">Kelola langkah-langkah untuk bergabung sebagai reseller
                        </p>
                    </div>
                    <!-- Add Step Button -->
                    <a href="{{ route('admin.reseller-content.steps.create') }}"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-2 ml-4">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.reseller-content.section.edit', ['sectionKey' => 'steps', 'section' => 'reseller-how-to-join-title']) }}"
                    ...
                    @foreach ($steps as $step)
                        <div
                            ...
                            <div
                                ...
                                <div class="flex items-center space-x-2 ml-4">
                                    <!-- Edit Button -->
                                    <a href="{{ route('admin.reseller-content.section.edit', ['sectionKey' => 'steps', 'section' => $step->section]) }}"
                                        class="text-blue-600 hover:text-blue-800 transition-all duration-300 p-2 rounded-full hover:bg-blue-100 hover:rotate-6"
                                    ...
                                    <!-- Delete Button -->
                                    <form
                                        action="{{ route('admin.reseller-content.section.delete', ['sectionKey' => 'steps', 'section' => $step->section]) }}"
                            ...
                            <div class="px-6 pb-6">
                                <div class="bg-white rounded-lg p-4 border-l-4 border-purple-500">
                                    <div class="flex items-start space-x-4">
                                        ...
                                        {{-- Content --}}
                                        <div class="flex-1">
                                            <h4 class="text-gray-800 font-bold text-lg mb-2">
