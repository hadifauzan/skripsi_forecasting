        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="bg-[#785576] p-6">
                <div class="flex items-center text-white">
                    <div>
                        <h3 class="text-xl font-semibold">Section perjalanan kami</h3>
                        <p class="text-purple-100 text-sm">Modifikasi perjalanan kami sesuai kebutuhan terkini</p>
                    </div>
                </div>
            </div>
                ...
                <div
                    ...
                    <div
                        ...
                        <div class="flex items-center space-x-2 ml-4">
                            <!-- Edit Button -->
                            <a href="{{ route('admin.about-us-content.edit-journey') }}"
