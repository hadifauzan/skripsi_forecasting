    ...
    <div class="px-6 py-8">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-[#785576] p-6 text-white">
                <h3 class="text-xl font-semibold">Form Edit Perjalanan Kami</h3>
                <p class="text-purple-100 text-sm">Edit konten informasi tentang perusahaan</p>
            </div>

            <form action="{{ route('admin.about-us-content.update-journey') }}" method="POST"
