...
@section('title', 'Edit Banner About Us')
...
@section('content')
    ...
    <div class="px-6 py-8">
        ...
        {{-- Edit Banner Image Form --}}
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            <div class="bg-[#785576] p-6 text-white">
                <h3 class="text-xl font-semibold">Form Edit Banner</h3>
                <p class="text-purple-100 text-sm">Upload gambar banner baru untuk halaman About Us</p>
            </div>

            <form action="{{ route('admin.about-us-content.update-banner', $section) }}" method="POST"
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="body" name="body" rows="4"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#785576]">{{ $content->body ?? '' }}</textarea>
                            @error('body')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div>
                            <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                                Pilih Gambar Banner <span class="text-red-500">*</span>
                            </label>
                        ...
                        <div>
                            ...
                            @if ($content && $content->image)
                                <img src="{{ Storage::url($content->image) }}" alt="Banner About Us"
                                    class="w-full h-48 object-cover rounded-lg shadow-md border">
                            @else
                                <div class="w-full h-48 bg-gray-200 flex items-center justify-center rounded-lg border">
